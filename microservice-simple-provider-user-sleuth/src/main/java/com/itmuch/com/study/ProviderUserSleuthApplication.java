package com.itmuch.com.study;

import com.itmuch.com.study.entity.User;
import com.itmuch.com.study.repository.UserRepository;
...
public class ProviderUserSleuthApplication {
  ...
  /**
   * 初始化用户信息 注：Spring Boot2不能像1.x一样，用spring.datasource.schema/data指定初始化SQL脚本，否则与actuator不能共存 原因详见：
